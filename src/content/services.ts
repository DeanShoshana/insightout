  ...
  pillars: [
    {
      ...
      body: 'Product work loses force when market logic, growth needs, specification, and implementation sit in separate rooms. This service turns the business question into product direction teams can actually build: clearer journeys, sharper requirements, stronger prototypes, and analytics hooks designed in from the start.',
      offerings: [
