  ...
  items: [
    {
      label: 'Technology',
      visual: 'product',
      entry: 'B2B and B2C product definition, mockups, requirements, instrumentation, and production-ready direction.',
      value:
