...
2. Brand tokens in SPEC.md §6/§6a are final (`--signal: #2470E5`, `--ink: #101828`).
   Never invent colors.
3. Brand assets live in `public/brand/claritix/` plus generated favicon/OG assets in
   `public/` - use them as-is unless a milestone explicitly replaces the brand system.
